          ...
          <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="bg-primary-50 text-primary-600 px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-primary-500 rounded-full animate-pulse"></div>
                  Real-time Availability
                </div>
                <Link
                  href="/domains/bulk-search"
                  className="text-xs font-bold text-gray-500 hover:text-primary-600 border border-gray-200 hover:border-primary-300 px-3 py-1.5 rounded-full transition-colors"
                >
                  Bulk Search
                </Link>
              </div>
