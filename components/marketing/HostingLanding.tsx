    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-14 sm:pt-16">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-blue-50/70 via-white to-white">
          <div className="absolute -top-24 -right-24 w-[30rem] h-[30rem] rounded-full bg-blue-100/50 blur-3xl pointer-events-none" />
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-gray-900 leading-[1.08] mb-5" style={{ fontFamily: 'Google Sans, system-ui, sans-serif' }}>
                  ...
                  <span className="bg-gradient-to-r from-[#0180E5] to-[#01489D] bg-clip-text text-transparent">FREE for 15 Days</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-6">
                  <Link href={TRIAL_CTA} className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#0180E5] to-[#01489D] hover:from-[#0177E1] hover:to-[#013A80] text-white font-bold py-3.5 px-7 rounded-xl shadow-lg hover:shadow-xl transition-all active:scale-95">
                    <Rocket className="h-5 w-5" />
                    Start Your 15-Day Free Trial
                  </Link>
                  <Link href="#pricing" className="inline-flex items-center justify-center gap-2 bg-white text-gray-800 font-bold py-3.5 px-7 rounded-xl border border-gray-200 shadow-sm hover:border-blue-300 hover:text-blue-700 transition-all">
                    View Hosting Plans
                  </Link>
                </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="w-32 shrink-0 border-r border-gray-100 p-3 hidden xl:block">
                      <div className="flex items-center gap-1.5 mb-4 px-1">
                        <div className="h-5 w-5 rounded bg-gradient-to-br from-[#0180E5] to-[#01489D]" />
                      ...
                      {['Dashboard', 'Websites', 'Domains', 'Emails', 'Files', 'Databases', 'Backups', 'Security', 'Settings'].map((n, i) => (
                        <div key={n} className={`flex items-center gap-1.5 px-2 py-1.5 rounded-lg mb-0.5 text-[11px] ${i === 0 ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-500'}`}>
                          <span className={`h-1.5 w-1.5 rounded-full ${i === 0 ? 'bg-blue-600' : 'bg-gray-300'}`} />
                          {n}
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="flex-1 p-4 min-w-0">
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-3">
                        {[
                          ...
                          { label: 'Storage', value: '12.6 / 20 GB', sub: '63% Used', tint: 'text-blue-600' },
                          { label: 'Bandwidth', value: '32 / 100 GB', sub: '32% Used', tint: 'text-blue-600' },
                        ].map((s) => (
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="col-span-2 rounded-lg border border-gray-100 p-3">
                          ...
                          <svg viewBox="0 0 200 60" className="w-full h-14">
                            <polyline fill="none" stroke="#0180E5" strokeWidth="2.5" points="0,45 28,40 56,44 84,30 112,34 140,20 168,24 200,8" />
                          </svg>
                        </div>
                        <div className="rounded-lg border border-gray-100 p-3">
                          ...
                          {['Create Website', 'Install WordPress', 'Add Domain'].map((a) => (
                            <p key={a} className="text-[9px] text-gray-500 mb-1 flex items-center gap-1"><span className="h-1 w-1 rounded-full bg-blue-400" />{a}</p>
                          ))}
                        </div>
                      </div>
                    </div>
        ...
        <section className="border-y border-gray-100 bg-white">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                <p className="text-[11px] font-bold tracking-[0.18em] uppercase text-blue-600 mb-3 text-center lg:text-left">Trusted by 1,000+ businesses</p>
            ...
            {FEATURES.map((f, i) => {
              ...
              return (
                <motion.div key={f.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.05 }}
                  className="group bg-white rounded-2xl p-5 border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-200 transition-all">
                  <div className="inline-flex p-2.5 rounded-xl bg-blue-50 text-blue-600 group-hover:bg-blue-100 transition-colors mb-3">
        ...
        <Section background="gray">
          ...
          <div className="max-w-2xl mx-auto overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div className="grid grid-cols-[1fr_auto_auto]">
              ...
              <div className="px-4 sm:px-6 py-4 bg-blue-600 border-b border-blue-700 text-sm font-bold text-white text-center whitespace-nowrap">Anutech</div>
              ...
              return (
                <motion.div key={step.num} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.08 }}
                  ...
                  <div className="relative w-16 h-16 mx-auto mb-4">
                    ...
                    <div className="relative flex items-center justify-center h-full"><Icon className="h-7 w-7 text-blue-600" /></div>
                    <span className="absolute -top-2 -right-2 h-7 w-7 rounded-full bg-blue-600 text-white text-xs font-bold flex items-center justify-center shadow-md border-2 border-white">{step.num}</span>
                  </div>
          ...
          <div className="flex justify-center mb-10">
            <div className="inline-flex items-center gap-3 bg-white border border-gray-200 rounded-full px-4 py-2 shadow-sm">
              ...
              <button
                ...
                className="relative h-6 w-12 rounded-full bg-blue-600 transition-colors"
              >
            ...
            {TESTIMONIALS.map((t, i) => (
              <motion.div key={t.name} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.06 }}
                ...
                <div className="flex items-center gap-3">
                  <div className="h-9 w-9 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-sm font-bold">{t.name.charAt(0)}</div>
                  <div>
        ...
        <Section background="gray">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            <div className="lg:col-span-1">
              <p className="text-xs font-bold tracking-[0.18em] uppercase text-blue-600 mb-3">Frequently asked questions</p>
        ...
        <section className="bg-gradient-to-r from-[#0180E5] to-[#01489D]">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-14 text-center">
            ...
            <p className="text-blue-100 mb-7 max-w-2xl mx-auto">Join 1,000+ businesses who trust Anutech for their online success.</p>
            <Link href={TRIAL_CTA} className="inline-flex items-center justify-center gap-2 bg-white text-[#01489D] font-bold py-3.5 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all active:scale-95">
              <Rocket className="h-5 w-5" />
              Start Your 15-Day Free Trial
