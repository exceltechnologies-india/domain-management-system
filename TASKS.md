...
**Currently live in production:** revision `dms-00113-tkg` (deployed 2026-06-10 08:06Z)
**Most-recent batch:** 19 customer-safety + admin-safety improvements shipped 8–10 Jun via 12 production deploys (every item below tagged with its live revision)
